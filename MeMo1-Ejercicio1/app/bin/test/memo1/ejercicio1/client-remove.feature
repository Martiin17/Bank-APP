Feature: Remove client
  ...
  Scenario: Cant remove a client with accounts
    Given A client with DNI: 12345, name: "Math", surname: "Johnson", direction: "Street 14" and born date: 19900413 with an account
    When I try to remove the client with DNI 12345
